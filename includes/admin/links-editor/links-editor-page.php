...
{	
	$tabs = array( 
		'--'			=>	__( 'Default', 'wp-ad-guru' ), 
		'home'			=> 	__( 'Home' , 'wp-ad-guru' ), 
		'singular'		=>	__( 'Singular', 'wp-ad-guru' ),
		'taxonomy' 		=>	__( 'Taxonomy', 'wp-ad-guru' ),
		'author'		=>	__( 'Author', 'wp-ad-guru'),
		'404_not_found'	=>	__( '404', 'wp-ad-guru' ),
		'search' 		=> 	__( 'Search', 'wp-ad-guru')
	); 
