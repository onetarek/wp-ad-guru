...
$args = array(
	'singular' => __("zone", "wp-ad-guru"),
	'plural'   => __("zones", "wp-ad-guru"),
	'base_url' => $base_url
);
...
<form id="adguru-zone-search-form" method="get" action="<?php echo esc_url( $base_url ); ?>" style="margin-top:5px;">
	<?php $zone_list_table->search_box( __( 'Search', 'wp-ad-guru' ), 'adguru_zone_search_input' ); ?>
...
<div id="zone_code_modal" title="Get Code">
	<div id="zone_code_content">
			<strong><?php esc_html_e( 'PHP CODE', 'wp-ad-guru' ) ?></strong><BR />
			<code id="zone_code_php">	</code><BR /><BR />
			<strong><?php esc_html_e( 'SHORTCODE', 'wp-ad-guru' ) ?></strong><BR />
