...
class ADGURU_Ad_Types{
	...
	private function make_post_type_args( $args ){
		...
		$labels = array(
			...
			'add_new'            => /* translators: %s: Post type name */ sprintf( _x( 'Add New', '%s', 'wp-ad-guru' ), $args['name'] ),
			'add_new_item'       => /* translators: %s: Post type name */ sprintf( __( 'Add New %s', 'wp-ad-guru' ), $args['name'] ),
			'new_item'           => /* translators: %s: Post type name */ sprintf( __( 'New %s', 'wp-ad-guru' ), $args['name'] ),
			'edit_item'          => /* translators: %s: Post type name */ sprintf( __( 'Edit %s', 'wp-ad-guru' ), $args['name'] ),
			'view_item'          => /* translators: %s: Post type name */ sprintf( __( 'View %s', 'wp-ad-guru' ), $args['name'] ),
			'all_items'          => /* translators: %s: Post type plural name */ sprintf( __( 'All %s', 'wp-ad-guru' ), $args['plural_name'] ),
			'search_items'       => /* translators: %s: Post type plural name */ sprintf( __( 'Search %s', 'wp-ad-guru' ), $args['plural_name'] ),
			'parent_item_colon'  => /* translators: %s: Post type plural name */ sprintf( __( 'Parent %s:', 'wp-ad-guru' ), $args['plural_name'] ),
			'not_found'          => /* translators: %s: Post type plural name */ sprintf( __( 'No %s found.', 'wp-ad-guru' ), $args['plural_name'] ),
			'not_found_in_trash' => /* translators: %s: Post type plural name */ sprintf( __( 'No %s found in Trash.', 'wp-ad-guru' ), $args['plural_name'] ),
		);		
