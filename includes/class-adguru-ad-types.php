...
class ADGURU_Ad_Types{
	...
	private function make_post_type_args( $args ){
		...
		$labels = array(
			...
			'add_new'            => sprintf( _x( 'Add New', '%s', 'wp-ad-guru' ), $args['name'] ),
			'add_new_item'       => sprintf( __( 'Add New %s', 'wp-ad-guru' ), $args['name'] ),
			'new_item'           => sprintf( __( 'New %s', 'wp-ad-guru' ), $args['name'] ),
			'edit_item'          => sprintf( __( 'Edit %s', 'wp-ad-guru' ), $args['name'] ),
			'view_item'          => sprintf( __( 'View %s', 'wp-ad-guru' ), $args['name'] ),
			'all_items'          => sprintf( __( 'All %s', 'wp-ad-guru' ), $args['plural_name'] ),
			'search_items'       => sprintf( __( 'Search %s', 'wp-ad-guru' ), $args['plural_name'] ),
			'parent_item_colon'  => sprintf( __( 'Parent %s:', 'wp-ad-guru' ), $args['plural_name'] ),
			'not_found'          => sprintf( __( 'No %s found.', 'wp-ad-guru' ), $args['plural_name'] ),
			'not_found_in_trash' => sprintf( __( 'No %s found in Trash.', 'wp-ad-guru' ), $args['plural_name'] ),
		);		
