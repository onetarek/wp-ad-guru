...
if (! class_exists('ADGURU_Content_Type_Image')) :
	...
	class ADGURU_Content_Type_Image extends ADGURU_Content_Type
	{
		...
		public function __construct()
		{
			...
			parent::__construct();
			$this->description = __('Link with image', 'wp-ad-guru');
		}
		...
		protected function _editor($ad, $error_msgs)
		{
			...
			echo '<p>' . $this->description . '</p>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		...
		protected function _print_content($ad)
		{
			...
			echo '<a href="' . $link_url . '" target="' . $link_target . '" ><img src="' . esc_url($source_url) . '" class="adguru_content_image" /></a>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		}
	} //end class
endif;
