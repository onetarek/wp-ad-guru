...
$sizing_form_args = array(
	...
	'fields' => array(
		'sizing_mode' => array(
			...
			'default'	=> 'responsive',
			'options' => array('responsive'=>__("Responsive", 'wp-ad-guru' ), 'custom'=>__("Custom", 'wp-ad-guru' )),
		),
		'sizing_responsive_size' => array(
			'type' 	=> 'select',
			'id'	=> 'sizing_responsive_size',
			'label'	=> __("Responsive Size", 'wp-ad-guru' ),
			'default'	=> '40',
			'options' => array(
				//'auto'=>__("Auto", 'wp-ad-guru' ), //Has issue with this option. We will think about this later.
				'10'=>__("10%", 'wp-ad-guru' ),
				'20'=>__("20%", 'wp-ad-guru' ),
				'30'=>__("30%", 'wp-ad-guru' ),
				'40'=>__("40%", 'wp-ad-guru' ),
		...
		'sizing_custom_width_group' => array(
			...
			'help' => __("Custom width of the popup container. Note : this value includes padding and border width value", 'wp-ad-guru' ),
			'fields' => array(
		...
		"sizing_auto_height" => array(
			...
			'label' => __('Auto Adjusted Height', 'wp-ad-guru' ),
			'default'	=> "1",
		),
		'sizing_custom_height_group' => array(
			...
			'help' => __("Custom height of the popup container. Note : this value includes padding and border width value", 'wp-ad-guru' ),
			'fields' => array(
		...
		'sizing_max_width_group' => array(
			...
			'label' => __("Max Width", 'wp-ad-guru' ),
			'help' => __("Maximum width of the popup container. Note : this value includes padding and border width value. Keep this 0 if you don't want to use max-width property", 'wp-ad-guru' ),
			'fields' => array(
		...
		'sizing_min_width_group' => array(
			...
			'label' => __("Min Width", 'wp-ad-guru' ),
			'help' => __("Minimum width of the popup container. Note : this value includes padding and border width value. Keep this 0 if you don't want to use min-width property", 'wp-ad-guru' ),
			'fields' => array(
		...
		'sizing_max_height_group' => array(
			...
			'label' => __("Max Height", 'wp-ad-guru' ),
			'help' => __("Maximum height of the popup container. Note : this value includes padding and border width value.  Keep this 0 if you don't want to use max-height property", 'wp-ad-guru' ),
			'fields' => array(
		...
		'sizing_min_height_group' => array(
			...
			'label' => __("Min Height", 'wp-ad-guru' ),
			'help' => __("Minimum height of the popup container. Note : this value includes padding and border width value.  Keep this 0 if you don't want to use min-height property", 'wp-ad-guru' ),
			'fields' => array(
		...
		"sizing_enable_scrollbar" => array(
			...
			'label' => __('Enable Scrollbar', 'wp-ad-guru' ),
			'default'	=> "1",
		),
