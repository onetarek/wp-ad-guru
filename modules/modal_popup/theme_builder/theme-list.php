...
<div id="theme_export_modal" title="Export Theme Data">
	<div id="theme_export_content">
			<?php _e( 'Copy following theme data', 'wp-ad-guru' ) ?><BR />
			<div id="theme_export_loading_box" class="hidden"><?php _e( 'Loading theme data', 'wp-ad-guru' ) ?>...</div>
...
<div id="theme_import_modal" title="Import Theme">
	<div id="theme_import_content">
			<?php _e( 'Put theme data below', 'wp-ad-guru' ) ?><BR />
			<div id="theme_import_loading_box" class="hidden"><?php _e( 'Importing theme data', 'wp-ad-guru' ) ?>...</div>
