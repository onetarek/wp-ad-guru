...
$args = array(
	'singular' => __("Modal Popup Theme", "wp-ad-guru"),
	'plural'   => __("Modal Popup Themes", "wp-ad-guru"),
	'base_url' => $base_url
);
...
<div style="margin-top:50px;">
	<input type="button" class="button-primary adguru-button" value="<?php echo esc_attr( __( 'Import Theme', 'wp-ad-guru' ) ) ?>" onclick="show_theme_import_modal()" style="height:40px; font-size:20px;line-height:20px;">
</div>
...
<div id="theme_export_modal" title="Export Theme Data">
	<div id="theme_export_content">
			<?php esc_html_e( 'Copy following theme data', 'wp-ad-guru' ) ?><BR />
			<div id="theme_export_loading_box" class="hidden"><?php esc_html_e( 'Loading theme data', 'wp-ad-guru' ) ?>...</div>
...
<div id="theme_import_modal" title="Import Theme">
	<div id="theme_import_content">
			<?php esc_html_e( 'Put theme data below', 'wp-ad-guru' ) ?><BR />
			<div id="theme_import_loading_box" class="hidden"><?php esc_html_e( 'Importing theme data', 'wp-ad-guru' ) ?>...</div>
